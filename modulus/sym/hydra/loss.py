...
def register_loss_configs() ->None:
    ...
    cs.store(group='loss', name='sum', node=AggregatorSumConf)
    cs.store(group='loss', name='grad_norm', node=AggregatorGradNormConf)
    cs.store(group='loss', name='res_norm', node=AggregatorResNormConf)
    cs.store(group='loss', name='homoscedastic', node=
        AggregatorHomoscedasticConf)
    cs.store(group='loss', name='lr_annealing', node=AggregatorLRAnnealingConf)
    cs.store(group='loss', name='soft_adapt', node=AggregatorSoftAdaptConf)
    cs.store(group='loss', name='relobralo', node=AggregatorRelobraloConf)
