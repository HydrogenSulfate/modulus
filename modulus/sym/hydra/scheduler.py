...
def register_scheduler_configs() ->None:
    ...
    cs.store(group='scheduler', name='exponential_lr', node=ExponentialLRConf)
    cs.store(group='scheduler', name='tf_exponential_lr', node=
        TFExponentialLRConf)
    cs.store(group='scheduler', name='cosine_annealing', node=
        CosineAnnealingLRConf)
    cs.store(group='scheduler', name='cosine_annealing_warm_restarts', node
